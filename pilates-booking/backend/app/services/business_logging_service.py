...
class BusinessEventLogger:
    ...
    # User Events
    def log_user_registered(self, user_id: str, email: str, registration_method: str = "web"):
    ...
    def log_login_failed(self, email: str, reason: str, client_ip: str, user_agent: str):
    ...
    # Booking Events
    def log_booking_created(self, user_id: str, class_id: str, booking_id: str, 
                           credits_used: int, booking_method: str = "web"):
    ...
    def log_booking_cancelled(self, user_id: str, class_id: str, booking_id: str,
                             reason: str, credits_refunded: int):
    ...
    def log_booking_checked_in(self, user_id: str, class_id: str, booking_id: str,
    ...
    # Package Events
    def log_package_purchased(self, user_id: str, package_id: str, credits: int,
    ...
    def log_package_credit_used(self, user_id: str, package_id: str, credits_used: int,
                               remaining_credits: int, used_for: str):
    ...
    # Payment Events
    def log_payment_success(self, user_id: str, payment_id: str, amount: float,
                           currency: str, payment_method: str, stripe_payment_id: str = None):
    ...
    def log_payment_failed(self, user_id: str, amount: float, currency: str,
                          reason: str, error_code: str = None):
        """Log failed payment."""
        self.log_event(
    ...
    def log_payment_refunded(self, user_id: str, payment_id: str, refund_amount: float,
                            reason: str, admin_id: str = None):
        """Log payment refund."""
        self.log_event(
    ...
    # Class Events
    def log_class_created(self, class_id: str, instructor_id: str, capacity: int,
                         start_time: datetime, admin_id: str = None):
        """Log class creation."""
        self.log_event(
    ...
    def log_class_cancelled(self, class_id: str, reason: str, admin_id: str,
    ...
    def log_settings_changed(self, admin_id: str, setting_name: str, 
...
def log_booking_created(user_id: str, class_id: str, booking_id: str, 
                       credits_used: int, booking_method: str = "web"):
    """Convenience function to log booking creation."""
    business_logger.log_booking_created(user_id, class_id, booking_id, credits_used, booking_method)


def log_payment_success(user_id: str, payment_id: str, amount: float,
                       currency: str, payment_method: str, stripe_payment_id: str = None):
    """Convenience function to log successful payment."""
    business_logger.log_payment_success(user_id, payment_id, amount, currency, payment_method, stripe_payment_id)


def log_admin_action(admin_id: str, action: str, target_type: str,
                    target_id: str, details: Dict[str, Any] = None):
