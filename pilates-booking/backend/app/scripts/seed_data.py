...
from app.models.class_schedule import ClassTemplate, ClassInstance, WeekDay, ClassLevel, ClassStatus
...
async def create_class_instances(session: AsyncSession, instructor: User, templates: list):
